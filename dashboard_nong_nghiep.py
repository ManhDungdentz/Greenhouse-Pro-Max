...
st.title("🌿 Hệ Thống Giám Sát Nhà Kính (Bản Màu Đậm)")
...
if uploaded_file:
    ...
    if not df.empty:
        ...
        if not df_valid.empty:
            ...
            # BIỂU ĐỒ ĐÃ TĂNG ĐỘ ĐẬM DẢI MÀU (Opacity 0.4)
            ...
            fig.add_hrect(y0=0, y1=0.8, fillcolor="rgba(30, 144, 255, 0.4)", line_width=0, row=1, col=1) # Blue
            fig.add_hrect(y0=0.8, y1=1.2, fillcolor="rgba(0, 200, 81, 0.4)", line_width=0, row=1, col=1) # Green
            fig.add_hrect(y0=1.2, y1=3.0, fillcolor="rgba(255, 75, 75, 0.4)", line_width=0, row=1, col=1) # Red
