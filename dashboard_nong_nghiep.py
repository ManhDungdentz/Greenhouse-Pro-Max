...
# --- HÀM VẼ BIỂU ĐỒ (GIỮ NGUYÊN DẢI MÀU CỦA ÔNG) ---
...
if mode == "📂 Xem file JSON":
    ...
    # --- CHẾ ĐỘ REALTIME (FIX DUPLICATE KEY + GIỮ NGUYÊN GIAO DIỆN) ---
    ...
    if run_realtime:
        ...
        for i in range(60, 0, -1):
            ...
            time.sleep(1)
        st.rerun() # Chạy lại toàn bộ để làm sạch Widget ID
    else:
